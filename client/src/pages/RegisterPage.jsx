    ...
    <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4">
      <div ref={cardRef} className="w-full max-w-md" style={{ opacity: 0 }}>
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-3xl p-6 sm:p-8">
          <h2 className="font-display text-2xl tracking-wide mb-6">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-white/50 text-xs uppercase tracking-wider mb-2" htmlFor="username">Username</label>
              <input
                id="username"
                name="username"
                type="text"
